...
set(CURL_LIBRARIES_PRIVATE "${VCPKG_IMPORT_PREFIX}/lib/libssh2.lib;${VCPKG_IMPORT_PREFIX}/lib/libssl.lib;${VCPKG_IMPORT_PREFIX}/lib/libcrypto.lib;${VCPKG_IMPORT_PREFIX}/lib/zs.lib;bcrypt;advapi32;crypt32;secur32;ws2_32;iphlpapi")
set(CURL_LIBRARIES_PRIVATE "")
set_and_check(CURL_INCLUDE_DIRS "${PACKAGE_PREFIX_DIR}/include")

set(CURL_SUPPORTED_PROTOCOLS "DICT;FILE;FTP;FTPS;GOPHER;GOPHERS;HTTP;HTTPS;IMAP;IMAPS;IPFS;IPNS;MQTT;MQTTS;POP3;POP3S;RTSP;SCP;SFTP;SMTP;SMTPS;TELNET;TFTP")
set(CURL_SUPPORTED_FEATURES "alt-svc;AsynchDNS;HSTS;HTTPS-proxy;IPv6;Kerberos;Largefile;libz;MultiSSL;SPNEGO;SSL;SSPI;threadsafe;TLS-SRP;Unicode;UnixSockets")
